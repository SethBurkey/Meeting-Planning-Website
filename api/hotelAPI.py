...
if len(sys.argv) == 2 and sys.argv[1] == '-t':
    cursor.execute("INSERT INTO hotels (name, location, price) VALUES (?, ?, ?)", ('Hotel A', 'NYC', '200.50'))
    cursor.execute("INSERT INTO hotels (name, location, price) VALUES (?, ?, ?)", ('Hotel B', 'LAX', '150.25'))       
    cursor.execute("INSERT INTO hotels (name, location, price) VALUES (?, ?, ?)", ('Hotel C', 'CHI', '180.75'))       
    cursor.execute("INSERT INTO hotels (name, location, price) VALUES (?, ?, ?)", ('Hotel D', 'SFO', '220.30'))       
    cursor.execute("INSERT INTO hotels (name, location, price) VALUES (?, ?, ?)", ('Hotel E', 'MIA', '190.60'))       
    cursor.execute("INSERT INTO hotels (name, location, price) VALUES (?, ?, ?)", ('Hotel F', 'LAS', '170.90'))       
    cursor.execute("INSERT INTO hotels (name, location, price) VALUES (?, ?, ?)", ('Hotel G', 'ATL', '210.40'))       
    cursor.execute("INSERT INTO hotels (name, location, price) VALUES (?, ?, ?)", ('Hotel H', 'SEA', '240.80'))       
    cursor.execute("INSERT INTO hotels (name, location, price) VALUES (?, ?, ?)", ('Hotel I', 'DFW', '230.70'))       
    cursor.execute("INSERT INTO hotels (name, location, price) VALUES (?, ?, ?)", ('Hotel J', 'DEN', '260.20'))       
    cursor.execute("INSERT INTO hotels (name, location, price) VALUES (?, ?, ?)", ('Hotel K', 'PHX', '270.35'))       
    cursor.execute("INSERT INTO hotels (name, location, price) VALUES (?, ?, ?)", ('Hotel L', 'BOS', '250.95'))       
